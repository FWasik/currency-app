...
class CustomChart extends StatelessWidget {
  ...
  const CustomChart({Key? key, required this.rates}) : super(key: key);
    ...
    return SingleChildScrollView(
      ...
      child: Container(
        ...
        child: Chart(
          ...
          marks: [
            IntervalMark(
                color: ColorEncode(variable: 'rate', values: Defaults.colors10),
                ...
                label: LabelEncode(
                    encoder: (tuple) => Label(
                          tuple['rate'].toString(),
                          LabelStyle(textStyle: const TextStyle(fontSize: 14)),
                        )))
          ],
          axes: [
